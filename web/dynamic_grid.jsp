...
<html>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0/css/bootstrap.min.css">
    ...
    <body>
        ...
        <br>
            <h3 style="font-family:Adamina, serif;text-align:center "><b>Comics Newly Arrived.</b></h3>
        <br>
        <%
             Connection con;
             Statement stm;
             ...
             try{
                ...
                con=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=library","sa","ISHWARi123");
                 ...
                 String query="SELECT * FROM image_upload INNER JOIN book_info ON image_upload.L_id = book_info.L_id where Type='Comics';";
                 ...
                 while(rs.next()){
                   ...
                   <div class="">
                       <div class="card col-md-3 text-center" style="float: left"  >
                           <a href="#" data-target="#hello" data-toggle="modal"><img  src="Books_Images/<%= imgpath %>" id="i1" style="width: 100%" alt="" ></a>
                           <div class="card-body">
